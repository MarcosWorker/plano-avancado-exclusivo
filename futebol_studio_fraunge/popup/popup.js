...
let inputGaleCancelado = document.getElementById("inputGaleCancelado");
let txtGaleCancelado = document.getElementById("txtGaleCancelado");
...
inputGaleCancelado.addEventListener("input", () => {
    if (inputGaleCancelado.value == 0) {
        txtGaleCancelado.textContent = `Dobrar no gale`;
    } else if (inputGaleCancelado.value == 1) {
        txtGaleCancelado.textContent = `Não dobrar no gale`;
    }
});
...
async function salvarLista() {
    ...
    config.galeCancelado = inputGaleCancelado.value;
...
function ocultarLogin() {
    ...
    inputGaleCancelado.style.display = "block";
    txtGaleCancelado.style.display = "block";
...
function ocultarConfig() {
    ...
    inputGaleCancelado.style.display = "none";
    txtGaleCancelado.style.display = "none";
...
function atualizaConfig(config) {
    ...
    if (config.galeCancelado == 0) {
        txtGaleCancelado.textContent = `Dobrar aposta no gale`;
    } else if (config.galeCancelado == 1) {
        txtGaleCancelado.textContent = `Não dobrar aposta no gale`;
    }
    ...
    inputGaleCancelado.value = config.galeCancelado;
